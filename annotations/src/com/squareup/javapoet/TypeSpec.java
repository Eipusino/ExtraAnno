...
public final class TypeSpec {
    ...
    private TypeSpec(Builder builder) {
        kind = builder.kind;
        name = builder.name;
        anonymousTypeArguments = builder.anonymousTypeArguments;
        ...
        typeVariables = Util.immutableList(builder.typeVariables);
        superclass = builder.superclass;
        superinterfaces = Util.immutableList(builder.superinterfaces);
        enumConstants = Util.immutableMap(builder.enumConstants);
        fieldSpecs = Util.immutableList(builder.fieldSpecs);
        staticBlock = builder.staticBlock.build();
        initializerBlock = builder.initializerBlock.build();
        methodSpecs = Util.immutableList(builder.methodSpecs);
        typeSpecs = Util.immutableList(builder.typeSpecs);
        alwaysQualifiedNames = Util.immutableSet(builder.alwaysQualifiedNames);
        ...
        originatingElements = Util.immutableList(originatingElementsMutable);
    }
    ...
    private TypeSpec(TypeSpec type) {
        ...
        enumConstants = Collections.emptyMap();
        fieldSpecs = Collections.emptyList();
        staticBlock = type.staticBlock;
        initializerBlock = type.initializerBlock;
        methodSpecs = Collections.emptyList();
        typeSpecs = Collections.emptyList();
        originatingElements = Collections.emptyList();
        nestedTypesSimpleNames = Collections.emptySet();
        alwaysQualifiedNames = Collections.emptySet();
    }
    ...
    public static final class Builder {
        ...
        public Builder superclass(TypeName superclass) {
            checkState(kind == Kind.CLASS, "only classes have super classes, not " + kind);
        ...
        public TypeSpec build() {
            ...
            for (Map.Entry<String, TypeSpec> enumConstant : enumConstants.entrySet()) {
                checkState(kind == Kind.ENUM, "%s is not enum", name);
