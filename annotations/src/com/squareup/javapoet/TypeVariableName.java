...
public final class TypeVariableName extends TypeName {
    ...
    private TypeVariableName(String nam, List<TypeName> bou) {
        this(nam, bou, new ArrayList<>());
    }

    private TypeVariableName(String nam, List<TypeName> bou, List<AnnotationSpec> annotations) {
        super(annotations);
        name = checkNotNull(nam, "name == null");
        bounds = bou;
    ...
    public TypeVariableName withBounds(List<? extends TypeName> bou) {
        ArrayList<TypeName> newBounds = new ArrayList<>();
        newBounds.addAll(bounds);
        newBounds.addAll(bou);
