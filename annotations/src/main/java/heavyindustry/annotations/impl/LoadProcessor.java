package heavyindustry.annotations.impl;
...
/** @author Anuke */
@SupportedAnnotationTypes("heavyindustry.annotations.Annotations.LoadRegs")
        ...
        if(round == 1){
            ...
            for(Element e : roundEnv.getElementsAnnotatedWith(LoadRegs.class)){
                ...
                for(String reg : ann.value()){
                    ...
                    load.addStatement("$L = $T.atlas.find($S)", name + "Region", cName(Core.class), "heavyindustry-" + reg);
                    ...
                    if(ann.outline()){
                        ...
                        load.addStatement("$L = $T.atlas.find($S)", name + "OutlineRegion", cName(Core.class), "heavyindustry-" + reg + "-outline");
                    }
                }
            }
