...
/**
 * Dupes a class, but simply changes its superclass to the one specified.
 * Also omits methods and fields marked with @Ignore.
 * @author Anuke
 */
@SupportedAnnotationTypes({
        "heavyindustry.annotations.Annotations.Dupe",
        "heavyindustry.annotations.Annotations.DupeComponent",
        "heavyindustry.annotations.Annotations.DupeInterface"
})
