                        ...
                        public Void visitClass(ClassTree node, Void unused) {
                            ...
                            if (
                                    sym != null &&
                                            !sym.isAnonymous() &&
                                            !(
                                                    sym.getQualifiedName().toString().startsWith("lonetrail.entities.comp") ||
                                                            sym.getQualifiedName().toString().startsWith("lonetrail.entities.merge") ||
                                                            sym.getQualifiedName().toString().startsWith("lonetrail.fetched")
                                            )
                            ) {
