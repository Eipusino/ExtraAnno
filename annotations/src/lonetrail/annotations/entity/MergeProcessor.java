...
public class MergeProcessor extends BaseProcessor {
    ...
    public Set<String> getSupportedAnnotationTypes() {
        return Set.of(Merge.class.getCanonicalName(), MergeComponent.class.getCanonicalName(), MergeInterface.class.getCanonicalName());
    }
    ...
    private static class MergeDefinition {
        ...
        MergeDefinition(String string, TypeSpec.Builder build, Element element, Seq<TypeElement> component, Seq<FieldSpec> field) {
            builder = build;
            name = string;
            naming = element;
