...
public class DupeProcessor extends BaseProcessor {
    ...
    public Set<String> getSupportedAnnotationTypes() {
        return Set.of(Dupe.class.getCanonicalName(), DupeComponent.class.getCanonicalName(), DupeInterface.class.getCanonicalName());
    }
    ...
    private static class DupeDefinition {
        ...
        DupeDefinition(String string, TypeSpec.Builder build, Element element, Seq<FieldSpec> field, String base) {
            builder = build;
            name = string;
            naming = element;
            fieldSpecs = field;
